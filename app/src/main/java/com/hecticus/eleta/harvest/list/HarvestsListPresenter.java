...
public class HarvestsListPresenter implements HarvestsListContract.Actions {
    ...
    public void handleSuccessfulMixedHarvestsRequest(List<Invoice> nonSortableInvoicesList) {
        ...
        //LogDataBase.d("DEBUG status1", String.valueOf(sortableInvoicesList.get(0).getStatusInvo()));
        //LogDataBase.d("DEBUG status2", String.valueOf(sortableInvoicesList.get(1).getStatusInvo()));
