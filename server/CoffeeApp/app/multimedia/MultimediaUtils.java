...
public class  MultimediaUtils {
    ...
    public static String transformToUniqueValidName(String name) throws MimeTypeException {
        StringBuilder uniqueValidName = new StringBuilder();
        uniqueValidName.append(UUID.randomUUID());
        if(name != null && !name.isEmpty()) {
            String validName = name.replaceAll(" ", "_").replaceAll("\\W+", "").toLowerCase();
            uniqueValidName.append("_");
            uniqueValidName.append(validName);
        }
        return uniqueValidName.toString();
    }
