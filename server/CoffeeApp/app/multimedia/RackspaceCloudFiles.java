...
public class RackspaceCloudFiles {
    ...
    private static String buildAbsolutePath(String relativePath){
        ...
        absolutePath.append(relativePath);                          // https://host.ssl.cf1.rackcdn.com/directory/filename_randomUUID.ext
    ...
    public static List<String> getObjectNames(String path){
        ListContainerOptions listContainerOptions = new ListContainerOptions();
        listContainerOptions.path(path);
