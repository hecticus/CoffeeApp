...
create table invoice_details (
  ...
  lot_id                        bigint,
  store_id                      bigint,
  price_item_type_by_lot        decimal(12,2),
  cost_item_type                decimal(12,2),
  amount_invoice_detail         decimal(12,2) not null,
...
create table invoicesdetails_purities (
  ...
  value_rate_invoice_detail_purity decimal(12,2),
  discount_rate_purity          decimal(12,2),
  total_discount_purity         decimal(12,2),
  deleted                       tinyint(1) default 0 not null,
  created_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null,
  updated_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP not null,
...
create table item_types (
  ...
  cost_item_type                decimal(12,2) not null,
  deleted                       tinyint(1) default 0 not null,
  created_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null,
  updated_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP not null,
...
create table lots (
  ...
  price_lot                     decimal(12,2) not null,
...
create table providers (
  ...
  constraint uq_providers_multimedia_profile_id unique (multimedia_profile_id),
...
create table purities (
  ...
  discount_rate_purity          decimal(12,2) not null,
  deleted                       tinyint(1) default 0 not null,
  created_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null,
  updated_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP not null,
