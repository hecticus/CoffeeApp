...
create table invoice_details (
  ...
  name_received_invoice_detail  varchar(100) not null,
  name_delivered_invoice_detail varchar(100) not null,
  note_invoice_detail           text,
  status_invoice_detail_id      bigint,
  freight_invoice_detail        tinyint(1) default 0 not null,
  status_delete                 tinyint(1) default 0 not null,
  created_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null,
  updated_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP not null,
...
create table invoicesdetails_purities (
  ...
  status_invoice_detail_purity  integer not null,
  status_delete                 tinyint(1) default 0 not null,
  created_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null,
  updated_at                    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP not null,
...
alter table invoice_details add constraint fk_invoice_details_id foreign key (id) references stores (id) on delete restrict on update restrict;
create index ix_invoice_details_id on invoice_details (id);
...
alter table invoicesdetails_purities add constraint fk_invoicesdetails_purities_id foreign key (id) references invoice_details (id) on delete restrict on update restrict;
create index ix_invoicesdetails_purities_id on invoicesdetails_purities (id);

alter table item_types add constraint fk_item_types_id foreign key (id) references units (id) on delete restrict on update restrict;
create index ix_item_types_id on item_types (id);

alter table lots add constraint fk_lots_id foreign key (id) references farms (id) on delete restrict on update restrict;
create index ix_lots_id on lots (id);
...
alter table invoice_details drop foreign key fk_invoice_details_id;
drop index ix_invoice_details_id on invoice_details;
...
alter table invoicesdetails_purities drop foreign key fk_invoicesdetails_purities_id;
drop index ix_invoicesdetails_purities_id on invoicesdetails_purities;

alter table item_types drop foreign key fk_item_types_id;
drop index ix_item_types_id on item_types;

alter table lots drop foreign key fk_lots_id;
drop index ix_lots_id on lots;
