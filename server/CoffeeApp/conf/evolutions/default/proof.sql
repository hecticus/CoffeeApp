...
INSERT INTO `invoices` (id_invoice,	status_delete,	id_provider,	status_invoice,	total_invoice) VALUES
(600,	0,	1131,	1,	500),
(601,	0,	1130,	1,	18),
(602,	1,	1130,	3,	39.00),
(603,	1,	1131,	3,	30),
...
id_provider	status_delete	identificationdoc_provider	fullname_provider	address_provider	phonenumber_provider
email_provider	photo_provider	id_providertype	contactname_provider	status_provider
...
(1130,	0,	'42424'	            , 'Cosechador Tes'      ,   'wweq'	, 332432	  ,'DSDSD@com.com'	  ,	2,	'Cosechador Test'),
(1131,	0,	'12345-4-2424 DV 24',	'Proveedor Te'	      ,   'Here'	, 52454547	,'pt@test.com'	    ,	1,	'None'),
(1132,	0,	'42343-2-4234 DV 32',	'Proveedor altern'    ,   'dsfdsf', 3424	    ,'ddfd@sds.com'	    ,	1,	'dfsdfsdf'),
(1133,	0,	'67567-5-7567 DV 56',	'Proveedor '	        ,   'dfsdf'	, 432	      ,'32432@as.com'	    ,	1,	'sdsd'),
(1134,	0,	'12121-2-1212 DV 12',	'PROV'                ,   '342343', 234234	  ,'32423@ASA.COM'	  ,	1,	'324'),
(1135,	0,	'32432-4-2342 DV 42',	'Proveedor accidenta' ,   'sdfsdf', 324234	  ,'fdsfsdf@asas.com'	,	1,	'dadsasd'),
(1136,	0,	'324234234234'	    , 'Cosechador novat'    ,   'wewe'	, 2323	    ,'sdsd@as.com'	    ,	2,	'Cosechador novato'),
(1137,	0,	'3324324234234'	    , 'Cosechador novele'   ,   'sdasda', 123434	  ,'asdasd@asas.com'	,	2,	'Cosechador novelero'),
...
INSERT INTO `farms` (id_farm, status_delete, name_farm, status_farm) VALUES
(1,1,'granja 1',      1);
(2,1,'granja 2',      1);
(3,1,'granja 3',      1);
(4,0,'Cafe de Eleta', 0);
...
INSERT INTO `units` (id_unit, name_unit, status_unit) VALUES
  (1,0,'libra');
...
INSERT INTO `lots`(id_lot, status_lot, name_lot, area_lot, heigh_lot, ,  status_delete, id_farm, price_lot) VALUES
  ...
  (6,   0,  'LOTE 6',     '58',     58,       0, 2, 58.00),
  (7,   1,  'LOTE 7',     '258',    258,      1, 2 ,258.00),
...
INSERT INTO `item_types` (`id_itemtype`,`status_delete`,`name_itemtype`,`cost_itemtype`,`status_itemtype`,`id_providertype`,`id_unit`) VALUES
...
(600, 0, 1131, 1, 500,),
(601, 0, 1130, 1, 18),
(602, 1, 1130, 3, 39.00000190734863),
(603, 1, 1131, 3, 30),
(604, 1, 1131, 3, 33000),
(605, 1, 1131, 3, 3000),
(606, 1, 1131, 3, 5000),
...
(608, 0, 1132, 1, 11008),
(609, 0, 1133, 1, 4300),
(610, 0, 1130, 1, 192.0000057220459),
(611, 0, 1131, 1, 21702),
(612, 0, 1134, 1, 20000),
(613, 1, 1130, 3, 211.8000087738037),
(614, 0, 1132, 1, 159264),
(615, 0, 1135, 1, 2652),
(616, 0, 1136, 1, 88.20000171661377),
(617, 0, 1130, 1, 63.60000228881836),
(618, 0, 1137, 1, 333.00001525878906),
(619, 0, 1130, 1, 33.60000228881836),
(620, 0, 1137, 1, 39.60000228881836),
(621, 0, 1137, 1, 34.80000305175781),
(622, 0, 1136, 1, 31.200000762939453),
(623, 0, 1136, 1, 657),
(624, 0, 1133, 1, 1000),
(625, 0, 1137, 1, 5.400000333786011),
(626, 0, 1134, 1, 410),
(627, 0, 1133, 1, 410),
(628, 0, 1136, 1, 142.8000030517578),
(629, 1, 1136, 3, 7.800000309944153),
(630, 0, 1137, 3, 12);
...
(1210,0,601,4,27,1,0.60,0.00,15,1,'Nada que ver','Edwin de respuesto','Cosechador Test',1),
(1211,0,601,5,27,1,0.60,0.00,15,1,'Nada que ver','Edwin de respuesto','Cosechador Test',1),
(1212,0,602,4,27,1,0.60,0.00,50,1,'Nada q ver','Edwin de respuesto','Cosechador Test',1),
(1213,0,602,5,27,1,0.60,0.00,15,1,'Nada q ver','Edwin de respuesto','Cosechador Test',1),
(1214,1,602,4,27,1,0.60,0.00,15,1,'NADA','Edwin de respuesto','Cosechador Test',1),
(1215,1,602,5,27,1,0.60,0.00,15,1,'NADA','Edwin de respuesto','Cosechador Test',1),
...
(1226,0,610,4,27,1,0.60,0.00,34,1,'DSFSFD','Edwin de respuesto','Cosechador Test',1),
(1227,0,610,5,27,1,0.60,0.00,36,1,'DSFSFD','Edwin de respuesto','Cosechador Test',1),
(1228,0,610,4,27,1,0.60,0.00,100,1,'DSFSDF','Edwin de respuesto','Cosechador Test',1),
(1229,0,610,5,27,1,0.60,0.00,150,1,'DSFSDF','Edwin de respuesto','Cosechador Test',1),
...
(1234,0,613,4,27,5,0.60,0.00,25,1,'DIF','Edwin de respuesto','Cosechador Test',1),
(1235,0,613,5,27,5,0.60,0.00,25,1,'DIF','Edwin de respuesto','Cosechador Test',1),
...
(1238,0,613,4,27,7,0.60,0.00,101,1,'fff','Edwin de respuesto','Cosechador Test',1),
(1239,0,613,5,27,7,0.60,0.00,202,1,'fff','Edwin de respuesto','Cosechador Test',1),
(1240,0,616,4,27,7,0.60,0.00,23,1,'Todo Ok','Edwin de respuesto','Cosechador novato',1),
(1241,0,616,5,27,7,0.60,0.00,124,0,'194','Edwin de respuesto','195',1),
(1242,0,617,1,27,7,0.60,0.00,51,1,'sdsd','Edwin de respuesto','Cosechador Test',1),
(1243,0,617,4,27,7,0.60,0.00,22,1,'sdsd','Edwin de respuesto','Cosechador Test',1),
(1244,0,617,5,27,7,0.60,0.00,33,1,'sdsd','Edwin de respuesto','Cosechador Test',1),
(1245,0,618,4,27,7,0.60,0.00,222,1,'Bad things','Edwin de respuesto','Cosechador novelero',1),
(1246,0,618,5,27,7,0.60,0.00,333,1,'Bad things','Edwin de respuesto','Cosechador novelero',1),
(1247,0,614,2,8,3,0.00,22.00,21,1,'26','Edwin de respuesto','25',1),
(1248,0,619,4,27,9,0.60,0.00,56,1,'','Andres Campo','Cosechador Test',1),
(1249,0,620,4,27,9,0.60,0.00,66,1,'','Andres Campo','Cosechador novelero',1),
(1250,0,621,4,27,9,0.60,0.00,58,1,'','Andres Campo','Cosechador novelero',1),
(1251,0,622,4,27,9,0.60,0.00,52,1,'awebao','Andres Campo','Cosechador novato',1),
(1252,0,623,4,27,9,0.60,0.00,60,1,'el café fue entregado a pedro','Andres Campo','Cosechador novato',1),
(1253,0,623,5,27,9,0.60,0.00,1000,1,'el café fue entregado a pedro','Andres Campo','Cosechador novato',1),
(1254,1,623,4,27,9,0.60,0.00,45,1,'','Andres Campo','Cosechador novato',1),
(1255,1,623,5,27,9,0.60,0.00,10,1,'','Andres Campo','Cosechador novato',1),
(1256,0,624,3,10,3,0.00,50.00,20,1,'','Andres Campo','juan',1),
(1257,0,623,4,27,11,0.60,0.00,15,1,'','Andres Campo','Cosechador novato',1),
(1258,0,623,5,27,11,0.60,0.00,20,1,'','Andres Campo','Cosechador novato',1),
(1259,0,625,4,27,11,0.60,0.00,7,1,'','Andres Campo','Cosechador novelero',1),
(1260,0,625,5,27,11,0.60,0.00,2,1,'','Andres Campo','Cosechador novelero',1),
(1261,0,626,1,12,3,0.00,20.50,20,1,'','Andres Campo','ma',1),
(1262,0,627,1,12,3,0.00,20.50,20,1,'','Edwin de respuesto','none',1),
(1263,0,628,4,27,13,0.60,0.00,238,1,'','Andres Campo','Cosechador novato',1),
(1264,0,629,4,27,13,0.60,0.00,12,1,'','Andres Campo','Cosechador novato',1),
(1265,0,629,5,27,13,0.60,0.00,1,1,'','Andres Campo','Cosechador novato',1),
(1266,0,630,4,27,13,0.60,0.00,20,1,'','Andres Campo','Cosechador novelero',1);
